...
type Contact struct {
	...
	View_all_tickets   bool                   `json:"view_all_tickets,omitempty"`
	Custom_fields      map[string]interface{} `json:"custom_fields,omitempty"`
	Deleted            bool                   `json:"deleted,omitempty"`
	Description        string                 `json:"description,omitempty"`
	Email              string                 `json:"email,omitempty"`
	Id                 int                    `json:"id,omitempty"`
	Job_title          string                 `json:"job_title,omitempty"`
	Language           string                 `json:"language,omitempty"`
	Mobile             string                 `json:"mobile,omitempty"`
	Name               string                 `json:"name,omitempty"`
	Other_emails       []string               `json:"other_emails,omitempty"`
	Phone              string                 `json:"phone,omitempty"`
	Tags               []string               `json:"tags,omitempty"`
	Time_zone          string                 `json:"time_zone,omitempty"`
	Twitter_id         string                 `json:"twitter_id,omitempty"`
	Unique_external_id string                 `json:"unique_external_id,omitempty"`
	Other_companies    []string               `json:"other_companies,omitempty"`
